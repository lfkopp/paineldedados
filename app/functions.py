...
opt_soc = {	'IDHM':{ 		'label':'IDH Municipal', 				'hover':'nome', 			'name':'IDHM',			'col':'IDHM', 'filename':IDHM, 				'desc':'oi tudo bem', 	'fonte':'http://www.atlasbrasil.org.br/'},
			...
			'ROYALTIES_PER_CAPITA':{	'label':'Royalties per capita', 'hover':'municipio', 	'name':'ROYALTIES_PER_CAPITA',		'col':'royalties per capita', 'filename':ROYALTIES, 	'desc':'oi tudo bem2', 	'fonte':'ANP, SICONFI, IBGE'},
