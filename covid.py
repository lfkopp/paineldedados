...
# %%
url = "http://sistemas.saude.rj.gov.br/tabnetbd/csv/covid_munic_diarioh16452005090.csv"
df = pd.read_csv(url,decimal=',', sep=';', encoding='latin-1', usecols=['Região de Saúde/Município','Casos','Óbitos','Casos  por 100.000 habitantes','Óbitos por 100.000 habitantes',"População 2019"])
...
# %%
finbra = pd.read_csv('D:/Dropbox/@UFRJ/observatorio/paineldedados/app/data/finbra_desp.csv', sep=';', decimal='.', usecols=['municipio','ano','10 - Saúde'])
...
df2.to_csv('D:/Dropbox/@UFRJ/observatorio/paineldedados/app/data/saude.csv', index=False)
# %%
# 
